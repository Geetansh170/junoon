        ...
        <div className="content-wrapper">
          ...
          <div className="rev_slider_wrapper fullscreen-container">
            <div id="slider10" className="rev_slider fullscreenbanner dark-wrapper" data-version="5.4.7">
              <ul>
                <li data-transition="fade" data-thumb="style/images/cover9.jpg"><img src={(window.innerWidth>768)?"style/images/cover9.jpg":"style/images/cover9_mobile.png" } alt="" /></li>
