                ...
                <div className="items row boxed grid-view text-center">
                  <div className="item col-md-6 col-lg-4">
                    <div className="box bg-inverse p-30">
                      <figure className="main mb-20 overlay overlay1 rounded"><a href="#"><img src="style/images/h1.jpg" alt="" /></a>
                        <figcaption>
                  ...
                  <div className="item col-md-6 col-lg-4">
                    <div className="box bg-inverse p-30">
                      <figure className="main mb-20 overlay overlay1 rounded"><a href="#"><img src="style/images/h2.jpg" alt="" /></a>
                        <figcaption>
                          <h5 className="text-uppercase from-top mb-0">See Gallery</h5>
                        </figcaption>
                      </figure>
                  ...
                  <div className="item col-md-6 col-lg-4">
                    <div className="box bg-inverse p-30">
                      <figure className="main mb-20 overlay overlay1 rounded"><a href="#"><img src="style/images/h5.jpg" alt="" /></a>
                        <figcaption>
                          <h5 className="text-uppercase from-top mb-0">See Gallery</h5>
                        </figcaption>
                      </figure>
                  ...
                  <div className="item col-md-6 col-lg-4">
                    <div className="box bg-inverse p-30">
                      <figure className="main mb-20 overlay overlay1 rounded"><a href="#"><img src="style/images/h4.jpg" alt="" /></a>
                        <figcaption>
                          <h5 className="text-uppercase from-top mb-0">See Gallery</h5>
                        </figcaption>
                      </figure>
                  ...
                  <div className="item col-md-6 col-lg-4">
                    <div className="box bg-inverse p-30">
                      <figure className="main mb-20 overlay overlay1 rounded"><a href="#"><img src="style/images/h3.jpg" alt="" /></a>
                        <figcaption>
                          <h5 className="text-uppercase from-top mb-0">See Gallery</h5>
                        </figcaption>
                      </figure>
                  ...
                  <div className="item col-md-6 col-lg-4">
                    <div className="box bg-inverse p-30">
                      <figure className="main mb-20 overlay overlay1 rounded"><a href="#"><img src="style/images/h6.jpg" alt="" /></a>
                        <figcaption>
                          <h5 className="text-uppercase from-top mb-0">See Gallery</h5>
                        </figcaption>
                      </figure>
                  ...
                  <div className="item col-md-6 col-lg-4">
                    <div className="box bg-inverse p-30">
                      <figure className="main mb-20 overlay overlay1 rounded"><a href="#"><img src="style/images/h7.jpg" alt="" /></a>
                        <figcaption>
                          <h5 className="text-uppercase from-top mb-0">See Gallery</h5>
                        </figcaption>
                      </figure>
                  ...
                  <div className="item col-md-6 col-lg-4">
                    <div className="box bg-inverse p-30">
                      <figure className="main mb-20 overlay overlay1 rounded"><a href="#"><img src="style/images/h8.jpg" alt="" /></a>
                        <figcaption>
                          <h5 className="text-uppercase from-top mb-0">See Gallery</h5>
                        </figcaption>
                      </figure>
                  ...
                  <div className="item col-md-6 col-lg-4">
                    <div className="box bg-inverse p-30">
                      <figure className="main mb-20 overlay overlay1 rounded"><a href="#"><img src="style/images/h9.jpg" alt="" /></a>
                        <figcaption>
                          <h5 className="text-uppercase from-top mb-0">See Gallery</h5>
                        </figcaption>
                      </figure>
                ...
                <div className="row isotope">
                  <div className="item post grid-sizer col-md-6 mb-0">
                    <div className="box bg-inverse">
                      ...
                      <h2 className="post-title"><a href="blog-post.html">Storygram 1</a></h2>
                  ...
                  <div className="item post grid-sizer col-md-6 mb-0">
                    <div className="box bg-inverse">
                      ...
                      <h2 className="post-title"><a href="blog-post.html">Storygram 2</a></h2>
                      <div className="post-content">
                        <p>
